...
<head>
    ...
    <script src="../assets/javascript/hospedar.js"></script>
    <!-- Select2 CSS y JS -->
        ...
        <div class="content-wrapper flex-grow-1 overflow-auto">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Hospedaje inmediato <span id="header-number"></span></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="reservar.php">Reservar</a></li>
                                    ...
                                    <form id="formReserva">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-8">
                                                ...
                                                <select class="select2" id="cliente_id" name="cliente_id" style="width: 100%;">
